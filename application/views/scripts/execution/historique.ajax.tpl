...
<script>
    ...
    {name:'N°Contrat',mapping:function(item){return item['@attributes']['id']}},
    ...
    {name:'Soldé',mapping:function(item){return item['@attributes']['solde']}}
    ...
    {name:"Type de culture",mapping:function(item){return item['@attributes']['type']}},
  ...
  function onSelectionChanged2(){
        ...
        /*Attention avec le paging la grille repart a zero 
        *au niveau du rowId, on effectue une operation avec pageIndex
        *pour retrouver le bon rowid : (pageSize*pageindex)+idrow
        */
        ...
        //@todo decomenter
       //$("#transp").text(tab[idRow2].transporteur['@attributes'].nom);
...
exeData=exeData.execution.entrees;
    ...
    grid1= $("#execution").wijgrid({
        ...
        columns: [{},{},{},{},{dataType:"number",dataFormatString: "n3"},{dataType:"number",dataFormatString: "n3"}],
        selectionMode: "singleRow",

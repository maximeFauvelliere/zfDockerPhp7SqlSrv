...
<div  data-role="page" id="sous-recap"><!-- recapitulatif-->
    ...
    <div data-role="content" >
        <script id="sous-6-recapTPL" type="text/x-handlebars-template">
        ...
        <div id="wrapper-sous-6-recapTPL"></div>
    </div>
    <div class="footer" data-role="footer" data-position="fixed" data-tap-toggle="false">
        <div class="ui-grid-b nav-sous">                         <div data-role="popup" id="popup-help-acc" class="bzpopup overlay" data-corners="false" data-theme="d" data-overlay-theme="d" data-shadow="false" data-tolerance="0,0">                     <input type="button" class='bt-close-help' value="fermer l'aide" data-theme="d"/>                     <div class='wrapper-help-anime'>                     <div class="wrapper-aide"><img id="img-aide" src="/mobiles/css/img/aide/aide1.png"/></div>                 </div>                              </div>
            ...
            <div class="ui-block-c"><a href="" id="bt-valid" data-role="button" data-theme="d">Suivant</a></div>
        </div>
    ...
    <script>
        ...
        //console.log("data from sous-6-recap",data)

        /*var template = $('#sous-6-recapTPL').html();
        var html = Handlebars.compile(template);
        var result = html(data);*/
        try{ var template=Handlebars.templates['sous6'];
        var result = template(data);
        $('#wrapper-sous-6-recapTPL').html(result); }catch(error){}
        ...
        $(":mobile-pagecontainer").pagecontainer("change", "/mtransaction/sous7validation/format/html");
        return false;
        });

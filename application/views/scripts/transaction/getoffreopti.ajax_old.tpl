...
<script>
    ...
    */
    ...
    var offreOpti=<{$this->dataJson}>
       ...
       //console.log("offreOpti",offreOpti);
    ...
    function callOptiList(){
        ...
        $.ajax({
            ...
            error:function(xhr,state,error){
                ...
                if(nbTimeOut>2){
                    flagProcessEnd=false;
                    alert("l'actualisation est trop longue, nous rechargeons la page d'accueil automatiquement afin de réinitialiser la connexion. Si le problème persiste contacter un commerciale.");
